...
class RecipeServiceTest
{
    ...
    @BeforeEach
    public void before() {
        recipeService = new RecipeService(recipeDao, recipeLikeDao);
    }
    ...
    void 全件検索できる() {
        ...
        when(recipeDao.findAll(null)).thenReturn(List.of(expect1, expect2));
        var actual = recipeService.findAll(null);
